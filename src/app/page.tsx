      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Runner, race enthusiast, and mile chaser.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            Welcome to my running blog. Here I share race reports, training
            insights, gear reviews, and everything I learn along the way. Every
            mile is a story worth telling.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/ajrequenez"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.nike.com/member/profile"
              aria-label="Follow on Nike Run Club"
